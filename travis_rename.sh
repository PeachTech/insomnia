...
find ./packages/insomnia-app/dist -type f -name *.AppImage -execdir mv {} Peach-Sidecar-Setup-$ver-x86_64-linux.AppImage \;
find ./packages/insomnia-app/dist -type f -name *.snap -execdir mv {} Peach-Sidecar-Setup-$ver-x86_64-linux.AppImage \;
find ./packages/insomnia-app/dist -type f -name *.dmg -execdir mv {} Peach-Sidecar-Setup-$ver-x86_64-mac.dmg \;
